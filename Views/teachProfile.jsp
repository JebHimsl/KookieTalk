...
<body>
	<div class="container-fluid">
		...
		<p>What information would you like students to know about you?  Your photo and this information will be visible to students.</p>
		...
		<form:form action="updateTeacher" modelAttribute="teacher"
			...
			<form:hidden path="emailAddress" value="${teacher.emailAddress }" />
			<form:hidden path="confirmEmail" value="${teacher.emailAddress }" />
			<form:hidden path="userId" value="${teacher.userId }" />
