...
public class UserDAOJDBC extends BaseDAO implements UserDAO {
	...
	public boolean saveAdmin(User user) {
		...
		try {
			...
			String query = "insert into user (user_name, password, email_address, first_name, last_name, middle_name, nick_name, home_phone, mobile_phone, work_phone, timezone_id) values (?,?,?,?,?,?,?,?,?,?,?)";
